...
var iHTML = new futures.glossary({
	...
	application: [{
		name: "The Mother Fucking Website",
		path: "http://motherfuckingwebsite.com"
	}],
	workshops: [{
...
var iCSS = new futures.glossary({
	...
	intro: "<p>Ruby is an expressive, dynamic programming language. Ruby on Rails is an open source web framework for building custom web applications. The courses in this section get you quickly up to speed with the basics of the Ruby language and on track to building your first Rails application.</p>",
	application: [{name: ""}],
	workshops: [{
...
var iOpenData = new futures.glossary({
	...
	intro: "<p>This is intro to Open Data</p>",
	application: [{name: ""}],
	workshops: [{
		name: "Wikipedia",
...
var iJavascript = new futures.glossary({
	...
	intro: "<p>JavaScript is the programming language of HTML and the Web.</p>",
	application: [{name: ""}],
	workshops: [{
		name: "Codeacademy",
